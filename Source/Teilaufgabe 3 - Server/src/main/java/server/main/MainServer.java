...
public class MainServer {
	 ...
	 * versions as otherwise the port would already be in use. You can do this in
	 * the debug screen, select the server instance and press the red stop button in
	 * the toolbar.
	 */
	...
	public static void main(String[] args) {
		...
		// sets the port programmatically. One could also set it based on the
		// .properties file
